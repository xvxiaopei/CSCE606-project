...
(1..100).each {|i| User.create!(name: "mashuo#{i}", email: "mashuo#{i}@gmail.com", password: "19930521", password_confirmation: "19930521", admin: false)}
...
# 3 groups
_group1=Group.create!(name: "TestGroup1", description: "Testing...", admin_uid: 102)
_group2=Group.create!(name: "TestGroup2", description: "Still testing...", group_level: "undergraduate",admin_uid:103)
_group3=Group.create!(name: "TestGroup3",admin_uid:104)
